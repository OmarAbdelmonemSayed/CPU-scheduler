  ...
  public void schedule(List<Process> processes) {
    ...
    while (!this.readyQueue.isEmpty()) {
      ...
      if (prevProcess != null && (!nextProcess.equals(prevProcess) || prevExecutionTime == prevQuantum)) {
        ...
        ExecutionRange eRange = new ExecutionRange(prevProcess, currentTime - prevExecutionTime, currentTime);
        executionRanges.add(eRange);
      ...
      if (nextProcess.getRemainingBurstTime() == 0) {
        ...
        executionOrder.add(e);
        ExecutionRange eRange = new ExecutionRange(nextProcess, currentTime - prevExecutionTime, currentTime);
        executionRanges.add(eRange);
        nextProcess = null;
